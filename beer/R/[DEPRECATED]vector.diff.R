...
# #' @param return what to return. Default is \code{c("angle", "projection", "rejection")}.
# #' @param scale whether to scale the base vector to be the unit (\code{TRUE}).
# #' 
# #' @details
# #' This is a modification from \code{\link[dispRity]{projections}} to align the vector with the base and output all the three elements (angle, projection and rejection) rather than just one.
# #' 
# #' @examples
# #'
# #' @seealso
...
# ## Internal: Rotate a matrix along one axis (y)
...
# }
# ## Internal: Angle between two vectors
