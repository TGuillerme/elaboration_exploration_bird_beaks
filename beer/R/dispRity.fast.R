#' @title Fast dispRity
#'
#' @description Fast dispRity calculations (but less safe than dispRity, see details)
#'
...
#' 
#' @details
#' \emph{USE \code{\link{dispRity}} INSTEAD OF THIS FUNCTION.}
#' This function should only be used in very specific cases requiring advanced optimisation.
