...
% change Gustavo's paper to /in press in current biology/
% Check if the ruminant paper is somewhere

\section{Introduction}

% TG: add these citations down there
...
% TG: TODO: just take Chris' paper acknowledgments
\textbf{Funding.}
...
% TG: TODO: add ERC grant (ask Gavin)
