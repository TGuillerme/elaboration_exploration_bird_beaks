...
%---------------------------------------------
% QUESTIONS/narrative
% How does phenotypic diversity arise?
% "Disparity" through time = how is disparity within clades partitioned wrt overall disparity. Diversity accumulates in a boring way, but doesn't tell us about mechanisms, 
% Lines of evolutionary least resistance theory. Very little testing 
% Test this using new method: elaboration/innovation
% How does this vary at different hierarchical levels - mega vs macro evolutionary?
% Species-level analyses
% Passerines

% Bits from Andrew
% A first insight into the evolutionary scale at which phenotypic diversity has arisen in birds comes from a simple exploration of the variance among major axes at different scales. If variance in the major axis is highest at the phylogenetic (mega) scale rather than the clade (macro) scale, it is evidence that diversity is very old.

% ANSWER

% Supporting this, we find overwhelming evidence that deep time evolutionary history does not constrain phenotypic variation.  This is evidenced by the orientation of evolution within clades being markedly different from and frequently orthogonal to the major phylogenetic axis, indicating that deep evolutionary history does not constrain diversity.

% DETAILS

% Against this backdrop, we then estimated the relative importance of elaboration or innovation to driving this pattern…. We made 3 specific investigations to do this....(Needs to be more precise about question, how we answer and answer - e.g. is elaboration most common at all evolutionary scales?  Is innovation isolated to evolutionary scales?).

% Trick to embed question in 'result'??
...
%This is basically a fake hypothesis - although we're testing that, the plot twist happens later!
...
There seems to be a nested structure of the variation in novelty %TODO: needs to introduce nestedness; %TODO: needs to introduce novelty.
...
% Paragraph 5+: Some elluipses stuff with bird names.
