...
%TG: just for info, here's the exact quote from Endler et al:
% innovation: if new components fall off the line;
% random innovation: new components fall off the line in random directions;
% specific innovation: new components fall off the line in only one direction (or a few)
