...
Avian phylogeny (n = 8748 species) showing Euclidean distance of species to the centroid of beak space (branches, cividis scale), and distributions of species beak shape $elaboration_{species}$ (inner circle, orange scale), and $innovation_{species}$ (outer circle, blue scale).
...
(Fig. \ref{Fig:phylogeny}), it is also commonly positively correlated with $innovation_{species}$ (Fig. \ref{fable_correlations} \ref{fable_correlations_supplementary}. %@L_correlation_figure_link).
...
\begin{figure}[!htbp]
\centering
   \includegraphics[width=1\textwidth]{Figures/correlations_fable_orders.pdf}
\caption{.}
...
$Elaboration_{clade}$ and $innovation_{clade}$ at the megaevolutionary scale for each order and super-order in the bird phylogeny.
...
Amount of orthogonality of each clade's phylogenetic major axis of beak variation compared to their parent or parent's parent clade.
...
\subsection{Species elaborate \textit{and} innovate, clades innovate} %TG: TODO: note in the response letter that we've now nuanced this
...
Comparisons of relative $elaboration_{species}$ and $innovation_{species}$ (Fig. \ref{Fig:phylogeny}) and $elaboration_{clade}$ and $innovation_{clade}$ (Fig. \ref{Fig:ellipses}).
