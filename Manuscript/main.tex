...
\begin{tabular}{rrllllllllrr}
  \hline
 Model & $E_{species}$ & $I_{species}$ & $E_{clade}$ & $I_{clade}$ & $E_{species}$ x $I_{clade}$ & $E_{species}$ x $E_{clade}$ & $I_{species}$ x $I_{clade}$ & $I_{species}$ x $E_{clade}$ & delta AIC & Adj. R2 \\ 
  \hline
