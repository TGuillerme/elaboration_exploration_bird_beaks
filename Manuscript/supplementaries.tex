...
we refer here to “macro” as the species focal level (i.e. using species rather than individuals as the unit of our analyses)
and “mega” as the clade level (i.e. using groups of species rather than individual species as the unit of our analyses)
...
\centering
\centering
   \includegraphics[width=0.5\textwidth]{Figures/Elaboration_and_innovation_through_time.pdf}
