...
\begin{figure}[htpb]
\centering
   \includegraphics[width=0.5\textwidth]{Figures/Elaboration_and_innovation_clade_through_time.pdf}
...
\begin{figure}[htpb]
\centering
   \includegraphics[width=0.5\textwidth]{Figures/Elaboration_and_innovation_species_through_time.pdf}
