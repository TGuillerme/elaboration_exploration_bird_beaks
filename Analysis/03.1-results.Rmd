...
```{r, fig.height = 20, fig.width = 10, echo = FALSE, eval = TRUE, results = 'hide', message = FALSE, warning = FALSE}
...
ploting_data <- list("median_elaborations" = apply(get.disparity(get.subsets(super_results_phylo$position, subsets = "phylogeny"), concatenate = FALSE)[[1]], 1, median),
                     "median_innovations"  = apply(get.disparity(get.subsets(super_results_phylo$distance, subsets = "phylogeny"), concatenate = FALSE)[[1]], 1, median),
...
save(ploting_data, file = "ploting_data.rda")
```
