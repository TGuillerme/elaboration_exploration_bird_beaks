...
order_results_within <- covar.projections.wrapper(order_shapespace,
                                            ...
                                            verbose = TRUE)
## Save all
allbirds_8748t_8Dshapespace_31levels_results_list <- list("super_results_between" = super_results_between,
...
wrap.plot(super_results_between,
...
wrap.plot(order_results_between,
...
## Plot the results
wrap.plot(super_results_within,
          col = rainbow(n.subsets(superorder_shapespace)-1),
...
## Plot the results
wrap.plot(order_results_within,
          col = rainbow(n.subsets(order_shapespace)-1),
          main = "Projections per order\nonto each order")
```
