...
params_shapespace_8D_31levels <- run.mini.chains(param_MCMCglmm, replicates = 1)
save(param_chains, file = "../Data/Processed/MCMCglmm/params_shapespace_8D_31levels_chain1.rda")
```
