...
param_chains <- list()
for(i in 1:3) {
    load(paste0("../Data/Cluster/allbirds_ 8748t_8Dshapespace_31levels/param_chains/params_shapespace_8D_31levels_20k_chain", i, ".rda"))
...
save(shapespace_8748t_8D_32level, file = "shapespace_8748t_8D_32level.mini.chains")
```
