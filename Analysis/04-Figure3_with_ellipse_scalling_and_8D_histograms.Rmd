...
covar.plot(suborder_shapespace, ellipses = mean,
           col = match.col(suborder_shapespace, tip_colours_suborders),
           legend = FALSE, points = FALSE, scale = "phylogeny",
           lines.lwd = c(rep(1, length(tip_colours_suborders)), 3),
           add = TRUE, n = 50)
...
covar.plot(family_shapespace, ellipses = mean,
           col = match.col(family_shapespace, tip_colours_families),
           legend = FALSE, points = FALSE, scale = "phylogeny",
           lines.lwd = c(rep(0.5, length(tip_colours_families)), 3),
           add = TRUE, n =50)
dev.off()
