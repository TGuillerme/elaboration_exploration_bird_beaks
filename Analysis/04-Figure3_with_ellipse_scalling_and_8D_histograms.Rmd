...
```{r, eval = TRUE, echo = FALSE}
## Get the bar plots for the loadings of the phylogeny component
# pdf(file = "../Manuscript/Figures/phylo_loadings.pdf", height = 4, width = 4)
# plot(NULL, xlim = range(superorder_shapespace$matrix), ylim = range(superorder_shapespace$matrix))
# add.dims(superorder_shapespace, name.col = c(phylogeny = "grey"), n = 1000)
# dev.off()
...
```{r}
## Adding the bar plot for the phylogeny component
# pdf(file = "../Manuscript/Figures/phylo_loadings.pdf", height = 4, width = 4)
