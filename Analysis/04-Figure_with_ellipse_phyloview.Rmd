...
tip_colours_orders <- plot.short.tree(tree, shapespace, "level2", tip.order = tip_order, colour.palette = grey.palette)
tip_colours_orders[1:length(tip_colours_orders)] <- "#191919"
...
## Black version
tip_colours_super_orders[1:length(tip_colours_super_orders)] <- "#191919"
## Grey version
# tip_colours_super_orders <- rep("#191919", length(tip_colours_super_orders))
