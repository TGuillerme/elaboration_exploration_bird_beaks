...
plot(original_pca$scores[,c(1,2)], col = "grey")
points(new_points[,c(1,2)], col = "orange", pch = 19)
points(original_pca$scores[c(1,2,3),c(1,2)], col = "blue", pch = 21)



## NOW NEEDS TO CHANGE FROM THE MORPHO PCA to PRINCOMP FORMAT AND BACK
```
