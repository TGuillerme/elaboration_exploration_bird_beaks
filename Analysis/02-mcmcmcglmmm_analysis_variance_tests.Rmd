...
save(params_shapespace_2D_9levels_20k, file = "../Data/Processed/MCMCglmm/params_shapespace_2D_9levels_20k_chain1.rda")
end <- Sys.time()
end - start
```
...
start <- Sys.time()
params_shapespace_2D_9levels_20k <- run.mini.chains(param_MCMCglmm, replicates = 1)
save(params_shapespace_2D_9levels_20k, file = "../Data/Processed/MCMCglmm/params_shapespace_2D_9levels_20k_chain2.rda")
end <- Sys.time()
end - start
```
...
start <- Sys.time()
params_shapespace_2D_9levels_20k <- run.mini.chains(param_MCMCglmm, replicates = 1)
save(params_shapespace_2D_9levels_20k, file = "../Data/Processed/MCMCglmm/params_shapespace_2D_9levels_20k_chain3.rda")
end <- Sys.time()
end - start
```
...
save(params_shapespace_8D_32levels_20k, file = "../Data/Processed/MCMCglmm/params_shapespace_8D_32levels_20k_chain1.rda")
end <- Sys.time()
end - start
```
...
start <- Sys.time()
params_shapespace_8D_32levels_20k <- run.mini.chains(param_MCMCglmm, replicates = 1)
save(params_shapespace_8D_32levels_20k, file = "../Data/Processed/MCMCglmm/params_shapespace_8D_32levels_20k_chain2.rda")
end <- Sys.time()
end - start
```
...
start <- Sys.time()
params_shapespace_8D_32levels_20k <- run.mini.chains(param_MCMCglmm, replicates = 1)
save(params_shapespace_8D_32levels_20k, file = "../Data/Processed/MCMCglmm/params_shapespace_8D_32levels_20k_chain3.rda")
end <- Sys.time()
end - start
```
