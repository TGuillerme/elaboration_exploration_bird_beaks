...
TODO:
 ...
 - [ ] make E/I boxes larger
 - [ ] make E/I colours always orange/blue

```{r, eval = TRUE, echo = FALSE}
## Get the bar plots for the loadings of the phylogeny component (to be added separately in Inkscape to the main plot)
...
box_size <- 1.5
pdf(file = "../Manuscript/Figures/ellipses.pdf", height = box_size*10, width = box_size*10)
