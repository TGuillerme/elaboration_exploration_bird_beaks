...
## Save as png and pdf
ggsave("../Manuscript/Figures/InnovElabTree_main_text.png", innovelab_plot_final, width=12, height=12)
ggsave("../Manuscript/Figures/InnovElabTree_main_text.pdf", innovelab_plot_final, width=12, height=12)
...
clades <- read.csv("../Data/Processed/BirdClades.csv")
