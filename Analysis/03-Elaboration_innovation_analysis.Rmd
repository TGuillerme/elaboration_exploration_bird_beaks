...
superorder_shapespace <- MCMCglmm.subsets(n = 100, #TG: Toggle this to 100 for a faster calculation
      data          = shapespace,
...
order_shapespace <- MCMCglmm.subsets(n = 100, #TG: Toggle this to 100 for a faster calculation
      data          = shapespace,
      posteriors    = shapespace_allbirds_lvl_superorder_order,
...
## Creating the subsets
suborder_shapespace <- MCMCglmm.subsets(n = 100, #TG: Toggle this to 100 for a faster calculation
      data          = shapespace,
      posteriors    = shapespace_passeriformes,
      group         = MCMCglmm.levels(shapespace_passeriformes)[c(suborder_lvl, phylo_lvl)],
      rename.groups = c(levels(shapespace$level1)[-1], "phylogeny")) #[-1] is because the first level is ""

family_shapespace <- MCMCglmm.subsets(n = 100, #TG: Toggle this to 100 for a faster calculation
      data          = shapespace,
      posteriors    = shapespace_passeriformes,
