...
## Plot all that
plot.density <- function(species, group, main, scale.x = TRUE, scale.y = TRUE, col = c("blue", "orange")) {
    scale.xy <- function(density, x = FALSE, y = TRUE) {
        if(x) {
