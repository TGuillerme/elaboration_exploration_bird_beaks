...
ploting_data_superorder <- list(
                     "median_elaborations" = apply(get.disparity(get.subsets(results$super_results_within$position, subsets = "phylogeny"), concatenate = FALSE)[[1]], 1, median),
                     "median_innovations"  = apply(get.disparity(get.subsets(results$super_results_within$distance, subsets = "phylogeny"), concatenate = FALSE)[[1]], 1, median),
                     "distances_to_centre" = get.disparity(dispRity(get.subsets(superorder_shapespace, subsets = "phylogeny"), metric = centroids, centroid = 0)),
                     "consensus_tree"      = tree) 

## Getting the plotting data super_order_level
ploting_data_order <- list(
                     "median_elaborations" = apply(get.disparity(get.subsets(results$order_results_within$position, subsets = "phylogeny"), concatenate = FALSE)[[1]], 1, median),
                     "median_innovations"  = apply(get.disparity(get.subsets(results$order_results_within$distance, subsets = "phylogeny"), concatenate = FALSE)[[1]], 1, median),
                     "distances_to_centre" = get.disparity(dispRity(get.subsets(superorder_shapespace, subsets = "phylogeny"), metric = centroids, centroid = 0)),
                     "consensus_tree"      = tree) 
...
super_orders <- mapply(add.col, one_order = super_orders[1:8], one_col = as.list(tip_colours_super_orders), SIMPLIFY = FALSE)
orders <- mapply(add.col, one_order = orders[1:27], one_col = as.list(tip_colours_orders), SIMPLIFY = FALSE)
