...
superorder_shapespace <- MCMCglmm.subsets(n = 4000,
      data          = shapespace,
...
order_shapespace <- MCMCglmm.subsets(n = 4000,
      data          = shapespace,
      posteriors    = shapespace_allbirds_lvl_superorder_order,
...
These sections are used for generated specific data for subsequent plots.
...
```{r}
## Plotting the novelty for the phylo picture:
