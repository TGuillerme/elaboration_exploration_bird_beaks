...
suborders <- mapply(add.col, one_order = suborders[1:8][match(names(suborders[1:8]), names(tip_colours_passeriformes_suborder))], one_col = as.list(tip_colours_suborders), SIMPLIFY = FALSE)
families <- mapply(add.col, one_order = families[1:27][match(names(families[1:27]), names(tip_colours_passeriformes_family))], one_col = as.list(tip_colours_families), SIMPLIFY = FALSE)
