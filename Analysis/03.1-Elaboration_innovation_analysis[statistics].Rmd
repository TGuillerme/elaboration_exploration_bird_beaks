...
legend("topleft", legend = c("Sub-orders (vs. passeriformes)", "Families (vs. sub-orders)", "Families (vs. passeriformes)"), col = c(gg.color.hue(4)[3], gg.color.hue(4)[4], adjustcolor(gg.color.hue(4)[4], alpha.f = 2/3)), pch = c(19, 19, 21), lty = c(1,1,2), cex = 0.8)
...
pdf("../Manuscript/Figures/relative_EI.pdf", height = 6, width = 12)
par(mfrow = c(1,2))
plot.density(species = c(elaboration_species),
             ...
             ylab    = "density",
             main    = "A - Total posterior elaboration per clade\n(scaled) and per species")
legend("topright", lty = 1, legend = c("species", "clades"), col = c("blue", "orange"))
text(x = 0.7, y = 0.5, paste0("Posterior area under the curve overlap\n(Bhattacharyya coefficient): ", round(bhatt.coeff(elaboration_species_auc, elaboration_group_auc), 3)))
plot.density(species = c(innovation_species),
             ...
             ylab    = "density",
             main    = "B - Total posterior innovation per clade\n(scaled) and per species")
text(x = 0.7, y = 0.5, paste0("Posterior area under the curve overlap\n(Bhattacharyya coefficient): ", round(bhatt.coeff(innovation_species_auc, innovation_group_auc), 3)))
dev.off()
```
