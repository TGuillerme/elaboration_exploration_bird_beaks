...
legend("topleft", legend = c("Super orders (vs. phylogeny)", "Orders (vs. phylogeny)", "Orders (vs. super orders)"), col = c(gg.color.hue(4)[1], gg.color.hue(4)[2], adjustcolor(gg.color.hue(4)[2], alpha.f = 2/3)), pch = c(19, 19, 21), lty = c(1,1,2), cex = 0.8)
dev.off()
```
