...
## Loading the parametrisation data
load(file = "../Data/Processed/shapespace_passeriformes_suborder_family.rda")

## Select the data
shapespace <- shapespace_passeriformes_suborder_family[[1]]$space
selected_dim <- shapespace_passeriformes_suborder_family[[1]]$dimensions
consensus_tree <- shapespace_passeriformes_suborder_family[[1]]$consensus_tree
trees_list <- shapespace_passeriformes_suborder_family[[1]]$trees_list
```
...
# Running the three MCMCglmm models
save(param_chains, file = "../Data/Processed/params_shapespace_8D_50levels_50k_chain1.rda")
```
...
param_chains <- list()
# for(i in 1:3) {
    load(paste0("../Data/Cluster/shapespace_passeriformes/param_chains/param_chain_passeriformes_50levels_chain", 1, ".rda"))
    param_chains[[1]] <- param_chain_passeriformes_50levels_chain1[[1]]
    load(paste0("../Data/Cluster/shapespace_passeriformes/param_chains/param_chain_passeriformes_50levels_chain", 2, ".rda"))
    param_chains[[2]] <- param_chain_passeriformes_50levels_chain1[[1]]
    load(paste0("../Data/Cluster/shapespace_passeriformes/param_chains/param_chain_passeriformes_50levels_chain", 3, ".rda"))
