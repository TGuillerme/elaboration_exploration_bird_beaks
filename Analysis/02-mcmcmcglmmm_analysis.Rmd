...
selected_dim <- shapsepace_passeriformes_suborder_family[[1]]$dimensions
consensus_tree <- shapsepace_passeriformes_suborder_family[[1]]$consensus_tree
trees_list <- shapsepace_passeriformes_suborder_family[[1]]$trees_list
```
...
## Running the three MCMCglmm models
save(param_chains, file = "../Data/Processed/MCMCglmm/params_shapespace_8D_29levels_5k_chain1.rda")
```
