...
param_chains <- list()
for(i in 1:3) {
    load(paste0("../Data/Cluster/shapespace_passeriformes/param_chains/params_shapespace_passeriformes_chain", i, ".rda"))
    param_chains[[i]] <- params_shapespace_passeriformes[[1]]
}
## Extract the parameters from the parameter chains
est_params <- extract.parameters(param_chains)
```
