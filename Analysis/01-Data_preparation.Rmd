...
All the custom code and custom functions called in this document can be downloaded and installed in `R`.

```{r packages_install, eval = FALSE}
## Optional - this snippet installs all the packages required to run the analyses
install.packages(c("devtools", "dispRity", "MCMCglmm", "xtable", "knitr", "ggplot2"))
