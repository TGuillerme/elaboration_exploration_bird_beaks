...
clades_list <- as.data.frame(read.csv("../Data/Raw/BirdClades.csv", row.names = 1, stringsAsFactors = TRUE))
clades_list_passeriformes <- clades_list[which(clades_list$level2_order == "Passeriformes"), c(3, 6)]
...
shapespace_passeriformes_suborder_family <- prep.data(
                                          level = 0, lvl.inc = c(1,2),
                                          ...
                                          trees     = trees_list,
                                          verbose   = TRUE)
save(shapespace_passeriformes_suborder_family, file = "../Data/Processed/shapespace_passeriformes_suborder_family.rda")
```
