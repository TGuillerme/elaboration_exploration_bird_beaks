...
BMise.space <- function(space, tree, dims) {
      ...
      ## Simulate the space
      return(sapply(space_var_prop, function(var, tree) fastBM(tree = tree, sig2 = var), tree))
}
...
------|------------|------------|---------------|----------------|----------------|
shapespace | from shapespace | 100 | 1 | 1000
randomspace | from shapespace | 100 | 25 | 1000
BMspace | from shapespace | 100 | 25 | 1000
ballspace | from ballspace | 100 | 1 | 1000
