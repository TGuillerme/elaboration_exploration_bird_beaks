...
group_elaboration <- dispRity.covar(covar_matrices,
               metric = projections.covar,
               between.groups = list(c(1,4), c(2,4), c(3,4)),
               measure = "position")
group_exploration <- dispRity.covar(covar_matrices,
               metric = projections.covar,
               between.groups = list(c(1,4), c(2,4), c(3,4)),
               measure = "distance")
group_angle <- dispRity.covar(covar_matrices,
               metric = projections.covar,
               between.groups = list(c(1,4), c(2,4), c(3,4)),
               measure = "degree")
par(mfrow = c(1,3))
plot(group_elaboration, ylab = "elaboration", col = colour_vector[-4])
plot(group_exploration, ylab = "exploration", col = colour_vector[-4])
plot(group_angle, ylab = "angle", col = colour_vector[-4])
```
...
## TODO: add option in dispRity plot to only select some groups
par(mfrow = c(1,3))
plot(phy_group_elaboration, col = colour_vector)
plot(phy_group_exploration, ylab = "exploration", col = colour_vector)
plot(phy_group_angle, ylab = "angle", col = colour_vector)
