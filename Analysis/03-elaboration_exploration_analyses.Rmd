...
Finally, we also looked at the exploration elaboration profiles within each clades by replacing for each clade, the projection of the elements onto $\vec{B}$ to the projection onto their respective clade major axes $\vec{a}$.
