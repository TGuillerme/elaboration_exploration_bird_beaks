...
col <- rev(c(rep(gg.color.hue(4)[1], 8), rep(gg.color.hue(4)[2], 27)))

par(mar = c(5, 17, 4, 2))
plot(NULL, xlim = c(0, 1), ylim = c(1,length(skewers_distrib)), xlab = "Skewers correlation", ylab = "", yaxt = "n")
abline(v = 0.5, lty = 2, col = "grey", lwd = 0.5)
axis(2, at = length(skewers_distrib):1, labels = plot_names, las = 2)
## Skewers
